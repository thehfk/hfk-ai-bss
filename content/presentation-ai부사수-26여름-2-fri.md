# presentation-ai부사수-26여름-2-fri.html
<!-- 이 파일의 각 블록 텍스트를 고치고 `python scripts/deck_content.py inject presentation-ai부사수-26여름-2-fri.html` 를 실행하면 발표 HTML에 반영됩니다. 슬롯 헤더(### sN-M)는 위치 키이니 지우지 마세요. -->
...
### s0-3  (p)
26여름 AI부사수 2회차 · 6월 19일 (금) · @Seulki.log
